...
namespace BKM {
	...
	public:
		...
		connection(owner parent, asio::io_context& asioContext, asio::ip::tcp::socket socket, DoubleStack<owned_message<T>>& qIn)
	...
	protected:
		...
		// of this connection
		DoubleStack<message<T>> m_qMessagesOut;

		// This references the incoming queue of the parent object
		DoubleStack<owned_message<T>>& m_qMessagesIn;
	...
	public:
		...
		DoubleStack<owned_message<T>>& Incoming()
		{
